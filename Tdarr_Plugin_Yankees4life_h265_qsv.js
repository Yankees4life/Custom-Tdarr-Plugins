...
const details = () => {
  return {
    id: "Tdarr_Plugin_Yankees4life_h265_QSV",
    Stage: "Pre-processing",
    Name: "Y4L H265 QSV",
    Type: "Video",
    Operation: "Transcode",
    Description: `[Contains built-in filter] This plugin transcodes all videos to h265 using QSV (if not in h265 already) and remuxes if not in mkv. If the English language track is not in AC3,EAC3 or DTS then an AC3 track is added.\n\n
`,
    Version: "1.00",
    Tags: "pre-processing,handbrake,ffmpeg,qsv h265",
    Inputs:[],
  };
}
